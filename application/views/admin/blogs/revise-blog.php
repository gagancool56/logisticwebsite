        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-outline card-info">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="<?= base_url('admin/revise-blog/' . $post['postid']) ?>" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="title">Title</label>
                                <input type="text" class="form-control" id="title" value="<?= $post['title'] ?>" name="title" placeholder="Enter title here">
                            </div>
                            <div class="form-group">
                                <label for="title">Cover Image (Dimension:750X350  Max size - 1.5 mb) (Optional)</label>
